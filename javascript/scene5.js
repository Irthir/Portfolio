...
export default class Scene5 extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        this.load.image('runbowitch','assets/Projets/RunbowItch.png');
    ...
    create ()
    {
        ...
        this.add.text(10,1035, "Manic Shooter", { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize : 18});

...
export default class Scene7 extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        this.load.image('storigweb','assets/Projets/StorigWeb.png');
    ...
    create ()
    {
        ...
        this.add.text(10,1035, "O.C.T.O.P.U.S.", { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize : 18});

        this.teleporter2 = this.add.sprite(70, 940, 'teleporter');
        this.teleporter2.setScale(2);
        this.teleporter2.anims.play('magic', true);
        this.add.text(1820,1035, "Paredre", { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize : 18});

        this.trigger1 = new Trigger(this,"Trigger",swords,"storigweb",1,"https://drusenheim.storig-box.com/",false,960,260,"De Storig Kaschte, Web");

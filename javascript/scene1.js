...
export default class Scene1 extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        this.add.text(45,1035, "Accueil", { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize : 18});

        this.teleporter2 = this.add.sprite(70, 940, 'teleporter');
        this.teleporter2.setScale(2);
        this.teleporter2.anims.play('magic', true);
        this.add.text(1738,1035, "Conception de Niveau", { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize : 18});

...
export default class Scene8 extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        this.load.image('paredreitch','assets/Projets/ParedreItch.png');
    ...
    create ()
    {
        ...
        this.add.text(10,1035, "Storig Kaschte", { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize : 18});
        ...
        this.trigger1 = new Trigger(this,"Trigger",swords,"paredreitch",1,"https://irthir.itch.io/paredre-prototype",false,960,260,"Paredre, Itch.io");
